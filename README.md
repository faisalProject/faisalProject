...
Lulusan Teknik Informatika dari Universitas Buana Perjuangan Karawang dengan keahlian sebagai Web Developer (Front-End & Back-End). Menguasai berbagai teknologi pengembangan web seperti HTML, CSS, JavaScript, PHP, Laravel, dan database MySQL. Berpengalaman dalam membangun aplikasi web yang responsif, fungsional, dan scalable.
